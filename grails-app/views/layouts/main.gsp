...
<!--<![endif]-->
	<head>
		...
		<title><g:layoutTitle default="JCadProject"/></title>
		...
		<!--fonts-->
		<link rel="stylesheet" href="${resource(dir: 'css', file: 'ace-fonts.css')}" type="text/css">

		<!--ace styles-->
		<link rel="stylesheet" href="${resource(dir: 'css', file: 'ace.min.css')}" type="text/css">
		<link rel="stylesheet" href="${resource(dir: 'css', file: 'ace-responsive.min.css')}" type="text/css">
		<link rel="stylesheet" href="${resource(dir: 'css', file: 'ace-skins.min.css')}" type="text/css">

		<!--[if lte IE 8]>
			<link rel="stylesheet" href="${resource(dir: 'css', file: 'ace-ie.min.css')}" type="text/css">
		<![endif]-->
	...
	<body>
					...
					<ul class="nav ace-nav pull-right">
						...
						<li class="green">
							...
							<ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-closer">
								...
								<li>
									<a href="#">
										<img src="${resource(dir: 'avatars', file: 'avatar.png')}" class="msg-photo" alt="Alex's Avatar" />
										<span class="msg-body">
								...
								<li>
									<a href="#">
										<img src="${resource(dir: 'avatars', file: 'avatar3.png')}" class="msg-photo" alt="Susan's Avatar" />
										<span class="msg-body">
											<span class="msg-title">
								...
								<li>
									<a href="#">
										<img src="${resource(dir: 'avatars', file: 'avatar4.png')}" class="msg-photo" alt="Bob's Avatar" />
										<span class="msg-body">
											<span class="msg-title">
		...
		<script src="${resource(dir: 'js', file: 'flot/jquery.flot.min.js')}"></script>
		<script src="${resource(dir: 'js', file: 'flot/jquery.flot.pie.min.js')}"></script>
		<script src="${resource(dir: 'js', file: 'flot/jquery.flot.resize.min.js')}"></script>
